'''
Generated by GPT-4
Takes a starting jpeg, a jpeg to compare with and outputs a greyscale jpg hiliting in whiter pixels the 
pixel differences.

Only been tested with 2 images so far. So may have bugs when images of different widths and heights, for example. 

I asked gpt4 to generate this function for me as a utility that I could use with Stable Diffusion and  Lora's like extra-detail 
so I could see the changes clearly made to the image.
'''
